...
import { FiChevronRight, FiClock, FiMapPin, FiPhone, FiCalendar } from "react-icons/fi";
    ...
    <div className="bg-light">
      ...
      >
        ...
        <div className="position-relative text-white text-center z-2 p-3" style={{ zIndex: 2 }}>
          <h1 className="fw-bold display-4 mb-3" data-aos="fade-down">Sejarah Museum Lampung</h1>
          <div
            className="mb-4"
            style={{
              width: "100px",
              ...
              <div className="card border-0 shadow-lg overflow-hidden">
                ...
                <div className="card-body p-4 p-lg-5">
                  <div className="lead text-muted mb-4">
                    ...
                    <p data-aos="fade-up">
                      Museum ini menyimpan sekitar 4.735 koleksi yang terbagi dalam 10 kategori:
                    </p>
                    <div className="row g-3 mt-2" data-aos="fade-up">
                      {['Geologika', 'Biologika', 'Etnografika', 'Historika', 
                        'Numismatika', 'Filologika', 'Keramologika', 
                        'Seni Rupa', 'Teknologika', 'Arkeologika'].map((item, idx) => (
                    ...
                    <p data-aos="fade-up">
                      Museum menampilkan pernak-pernik aksesori dari dua kelompok adat dominan:
                    </p>
                    <div className="row g-4 mt-3">
                      <div className="col-md-6" data-aos="zoom-in">
                        <div className="h-100 bg-white p-4 rounded-4 shadow border-top border-4 border-primary">
                          <h5 className="text-center fw-bold text-primary mb-3">Saibatin</h5>
                      ...
                      <div className="col-md-6" data-aos="zoom-in" data-aos-delay="200">
                        <div className="h-100 bg-white p-4 rounded-4 shadow border-top border-4 border-primary">
                          <h5 className="text-center fw-bold text-primary mb-3">Pepadun</h5>
                    ...
                    <div className="mt-5 p-4 rounded-3" style={{background: "linear-gradient(135deg, #0D6EFD, #0dcaf0)"}} data-aos="fade-up">
              ...
              >
                <div className="card border-0 shadow-lg" data-aos="fade-left">
                  ...
                  <div className="card-body p-0">
                   <ul className="timeline p-3">
                      {[
                        { year: '1975', event: 'Pembangunan Dimulai', detail: 'Peletakan batu pertama oleh Gubernur Lampung' },
                        { year: '1988', event: 'Peresmian Museum', detail: 'Diresmikan oleh Menteri Pendidikan dan Kebudayaan' },
                        { year: '1990', event: 'Penambahan Koleksi', detail: 'Pemerintah menambah 2.000 koleksi baru' },
                        { year: '2005', event: 'Renovasi Gedung Utama', detail: 'Perluasan area pameran dan fasilitas' },
                        { year: '2011', event: 'Digitalisasi Koleksi', detail: 'Memulai proses digitalisasi arsip dan koleksi' },
                        { year: '2020', event: 'Virtual Tour', detail: 'Meluncurkan tur virtual selama pandemi' },
                      ].map((item, idx) => (
                        <li 
                          key={idx} 
                        ...
                        >
                          ...
                          <div className="timeline-content p-3 shadow-sm rounded-3">
                            <div className="d-flex justify-content-between align-items-center mb-2">
                              <h6 className="fw-bold mb-0 text-primary">{item.year}</h6>
                              <span className="badge bg-primary bg-opacity-10 text-primary">Sejarah</span>
                            </div>
                ...
                <div className="card border-0 shadow-lg mt-4" data-aos="fade-left" data-aos-delay="300">
                  <div className="card-header bg-primary text-white fw-bold py-3">
                    <div className="d-flex align-items-center">
