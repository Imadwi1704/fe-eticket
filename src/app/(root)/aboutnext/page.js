          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 col-12" data-aos="fade-left">
              ...
              <p className="text-dark">
                Museum ini merupakan pusat pelestarian budaya Lampung yang menampung lebih dari 15.000 koleksi bersejarah.
                Dengan arsitektur tradisional Lampung yang megah, museum ini menjadi ikon budaya provinsi Lampung.
              </p>
        ...
        <div className="container">
          <div className="row g-4">
            ...
            <div className="col-md-4" data-aos="fade-up">
              ...
              >
                <div className="card-body p-4" style={ {backgroundColor: "#E8F9FD"} }>
                  <div className="d-flex align-items-center mb-3">
                    <div className="icon-box bg-primary-light text-primary rounded-circle d-flex align-items-center justify-content-center me-3">
                      <i className="bi bi-collection fs-2"></i>
                    </div>
                    <h3 className="fw-bold mb-0">15.000+</h3>
                  </div>
              ...
              >
                <div className="card-body p-4" style={ {backgroundColor: "#E8F9FD"} }>
                  <div className="d-flex align-items-center mb-3">
                    ...
                    <h3 className="fw-bold mb-0">120.000+</h3>
                  </div>
                  <p className="text-muted mb-0">
        ...
        <div className="container position-relative z-1">
          <div className="row g-5">
            <div className="col-lg-5 col-12" data-aos="fade-right">
              <h2 className="fw-bold mb-4 text-white">Sejarah Museum Ruwai Jurai</h2>
              ...
              <div className="bg-dark-light p-4 rounded">
                ...
                <ul className="list-unstyled timeline">
                  <li className="mb-4 position-relative ps-4">
                    ...
                    <h5 className="fw-bold mb-2 text-white">1975 - Perencanaan Awal</h5>
                    <p className="text-white">Dimulai sebagai proyek budaya provinsi dengan dukungan pemerintah daerah.</p>
                  </li>
                  <li className="mb-4 position-relative ps-4">
                    <div className="timeline-badge"></div>
                    <h5 className="fw-bold mb-2 text-white">1985 - Pembangunan Gedung</h5>
                    <p className="text-white">Pembangunan gedung utama dengan arsitektur tradisional Lampung.</p>
                  </li>
                  <li className="mb-4 position-relative ps-4">
                    <div className="timeline-badge"></div>
                  ...
                  <li className="position-relative ps-4">
                    <div className="timeline-badge"></div>
                    <h5 className="fw-bold mb-2 text-white">2000-Sekarang - Pengembangan</h5>
                    <p className="text-white">Perluasan koleksi dan fasilitas untuk melayani masyarakat lebih baik.</p>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="col-lg-10 mx-auto">
              <div className="card border-0 shadow rounded-3 overflow-hidden">
                <div className="card-body p-0">
                  <ul className="nav nav-tabs nav-fill bg-light" id="infoTab" role="tablist">
                    {["Jam Operasional", "Tata Tertib", "Harga Tiket"].map((label, i) => (
                      <li key={i} className="nav-item" role="presentation">
                        <button
                          className={`nav-link ${i === 0 ? "active" : ""} fw-bold py-3`}
                          id={`${label}-tab`}
                          data-bs-toggle="tab"
                  ...
                  <div className="tab-content p-4 p-lg-5" id="infoTabContent">
                    <div className="tab-pane fade show active" id="jamoperasional" role="tabpanel">
                      <div className="row align-items-center">
                        <div className="col-md-3 text-center mb-4 mb-md-0">
                          <i className="bi bi-clock fs-1 text-primary"></i>
                        </div>
                        <div className="col-md-9">
                          <h4 className="fw-bold mb-3">Jam Operasional Museum</h4>
                    ...
                    <div className="tab-pane fade" id="tatatertib" role="tabpanel">
                      <div className="row align-items-center">
                        <div className="col-md-3 text-center mb-4 mb-md-0">
                    ...
                    <div className="tab-pane fade" id="hargatiket" role="tabpanel">
                      <div className="row align-items-center">
                        <div className="col-md-3 text-center mb-4 mb-md-0">
                            ...
                            <div className="col-md-6 mb-3">
                              <div className="card border-0 shadow-sm h-100">
                                <div className="card-body text-center py-4">
                                  <h5 className="fw-bold text-primary">Dewasa</h5>
                                  <h2 className="fw-bold my-3">Rp 5.000</h2>
                                  <p className="text-muted small mb-0">Per orang</p>
                                </div>
                              </div>
                            </div>
                            <div className="col-md-6 mb-3">
                              <div className="card border-0 shadow-sm h-100">
                                <div className="card-body text-center py-4">
                                  <h5 className="fw-bold text-primary">Pelajar/Mahasiswa</h5>
                                  <h2 className="fw-bold my-3">Rp 2.000</h2>
                                  <p className="text-muted small mb-0">Dengan menunjukkan kartu pelajar</p>
                                </div>
                              </div>
                            </div>
                          </div>
