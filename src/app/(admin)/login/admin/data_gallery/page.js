...
const NotificationToast = ({ notification, setNotification }) => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 animate-fade-in">
      <div className={`${bgColor} ${textColor} p-4 rounded-lg shadow-lg flex items-start max-w-md`}>
        {icon}
              ...
              <div className="d-flex justify-content-between align-items-center mb-4">
                <div>
                  <p className="text-muted mb-0">
                    Kelola data gallery museum. Anda dapat menambah, mengedit, atau menghapus koleksi.
                  </p>
                </div>
                <button 
      ...
      {showConfirmModal && (
        <div className="modal show d-block" style={{ backgroundColor: "rgba(0,0,0,0.5)" }}>
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header" style={{ borderBottomColor: 'rgba(13, 110, 253, 0.2)' }}>
                <h5 className="modal-title fw-bold" style={{ color: '#0d6efd' }}>Konfirmasi Penghapusan</h5>
                <button 
                  className="btn-close" 
