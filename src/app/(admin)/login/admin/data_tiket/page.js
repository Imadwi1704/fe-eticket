...
export default function TicketAdminPage() {
  ...
  const NotificationToast = ({ notification }) => {
    ...
    return (
      <div className={`fixed top-6 right-6 z-50 transition-all duration-300 transform ${bgColor} text-white rounded-lg shadow-lg overflow-hidden animate-fade-in`}>
        ...
        <div className="h-1 bg-white bg-opacity-30 w-full">
          <div 
            className="h-full bg-white bg-opacity-70 animate-progress"
          />
        </div>
      </div>
    );
  ...
  return (
    <>
        ...
        <div className="container py-5">
          <div className="card shadow-sm border-0">
            <div className="card-header bg-primary text-white">
              <h2 className="card-title fw-semibold mb-0 text-white">Data Tiket Museum Lampung</h2>
            </div>
            <div className="card-body p-4">
              <p className="text-muted mb-4">
                Kelola data tiket museum. Anda dapat menambah, mengedit, atau menghapus tiket.
              </p>
                    ...
                    <tbody>
                      {data.map((item, idx) => (
                        <tr key={item.id}>  
                          <td>{idx + 1}</td>
                          <td>
                            <span className="badge bg-primary bg-opacity-10 text-white w-50">{item.code}</span>
                          </td>
                          <td>{item.type}</td>
                          <td>{formatPrice(item.price)}</td>
                          <td className="text-truncate" style={{ maxWidth: "300px" }} title={item.terms}>
                            {item.terms}
                          </td>
                          <td>
      ...
      {/* Add Modal */}
      {showModal && (
        <div className="modal fade show d-block" style={{ backgroundColor: "rgba(0,0,0,0)" }} tabIndex="-1">
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }}>
                  <div className="mb-3">
                    <label className="form-label">Kode Tiket <span className="text-danger">*</span></label>
                    <input 
                      type="text" 
                      name="code" 
                  ...
                  <div className="mb-3">
                    <label className="form-label">Jenis Tiket <span className="text-danger">*</span></label>
                    <input 
                      type="text" 
                      name="type" 
                      className="form-control" 
                  ...
                  <div className="mb-3">
                    <label className="form-label">Syarat dan Ketentuan <span className="text-danger">*</span></label>
                    <textarea 
                      name="terms" 
                      className="form-control" 
                      rows="5" 
                      ...
                      required
                    ></textarea>
                    <div className="form-text">Gunakan titik koma (;) untuk memisahkan poin-poin</div>
                  </div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <div className="alert alert-warning p-2">
                  <p className="mb-1"><strong>Kode:</strong> {ticket.code}</p>
                  <p className="mb-1"><strong>Jenis:</strong> {ticket.type}</p>
                  <p className="mb-0"><strong>Harga:</strong> {formatPrice(ticket.price)}</p>
                </div>
